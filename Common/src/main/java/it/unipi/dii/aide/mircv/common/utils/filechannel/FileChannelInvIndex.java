package it.unipi.dii.aide.mircv.common.utils.filechannel;
...
public class FileChannelInvIndex {
    ...
    private static final Path doc_id_path = Path.of("resources/output/inverted_index_doc_id_bin.dat");
    private static final Path term_freq_path = Path.of("resources/output/inverted_index_term_frequency_bin.dat");
